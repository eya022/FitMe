          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                        ...
                        LineChart(
                          LineChartData(
                            ...
                            borderData: FlBorderData(
                              show: true,
                              border: Border.all(
                                color: Color.fromARGB(0, 203, 55, 55),
                              ),
                            ),
                          ),
                        )
                        ...
                        child: Row(
                          children: [
                            SimpleAnimationProgressBar(
                              ...
                              foregrondColor: TColor.secondaryColor1,
                              ratio: 0.5,
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        ...
                                        SimpleCircularProgressBar(
                                          ...
                                          backColor: Color.fromARGB(255, 199, 199, 199),
                ...
                Container(
                  decoration: BoxDecoration(
    color:TColor.black.withOpacity(0.9),
                        ...
                        lineTouchData: LineTouchData(
                          ...
                          getTouchedSpotIndicator: (LineChartBarData barData,
                            ...
                            return spotIndexes.map((index) {
                              return TouchedSpotIndicatorData(
                                FlLine(
                                  color: Color.fromARGB(250, 11, 11, 11),
                                ),
                                FlDotData(
                                  show: true,
